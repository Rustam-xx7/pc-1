...
const Login = () => {
  ...
  return (
    <div className="text-white flex flex-col gap-4 justify-center items-center h-full w-full my-2 py-4">
      <h2 className="font-bold text-2xl  ">
        Login To Get Your Fans to Support
      </h2>
      <div className="login-box h-fit w-[40vw] bg-black/20 px-2 pb-6 rounded-2xl flex justify-center ">
        <div className="flex flex-col gap-2 min-h-fit p-10">
